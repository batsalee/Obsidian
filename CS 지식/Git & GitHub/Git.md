...
10) Fork : 프로젝트를 직접 변경할 권한을 갖지 못했을 때 그러한 ==프로젝트를 자신의 계정으로 복사==해와야 하는데 그 과정을 리포지토리를 fork한다고 함, fork하면 자신의 github에 새로운 레포지토리가 생성되고 해당 프로젝트가 옮겨와짐, 다만 git 변경 내역은 얻을 수 없음, fork 후 Clone하고 변경하고 pull request를 이용해 원본 프로젝트에 변경 내용을 반영해달라고 요청 할 수 있음
